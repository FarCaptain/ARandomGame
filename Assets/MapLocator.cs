...
public class MapLocator : MonoBehaviour
{
    ...
    private Dictionary<Vector2Int, GameObject> m_Map = new Dictionary<Vector2Int, GameObject>();
    ...
    public void AddItem(Vector2Int coord, GameObject item)
    {
    ...
    public void UpdateItem(Vector2Int oldCoord, Vector2Int newCoord)
    {
        ...
        {
            GameObject item = m_Map[oldCoord];
    ...
    public void UpdateItem(Vector2Int oldCoord, Vector2Int newCoord, GameObject item)
    {
        if (m_Map.ContainsKey(oldCoord))
        {
            m_Map.Remove(oldCoord);
    ...
    public GameObject FindItem(Vector2Int coord)
    {
        if(m_Map.ContainsKey(coord))
        {
            return m_Map[coord];
